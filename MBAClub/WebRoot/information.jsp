...
<%
	...
	pageBean.setPageAction("information.jsp");
	pageBean.setTotalRecords(newsDao
			.getNewsCountByCategoryID(newsDao.NEWS_CATEGORY_INFO_EXCHANGE));

	List<News> newsList = newsDao.getNewsByCategoryID(
			newsDao.NEWS_CATEGORY_INFO_EXCHANGE, (pageNo - 1) * PAGE_SIZE,
			PAGE_SIZE);
	...
	<body>
		...
		<div class="page-nav wrapper">
			<ul class="clearfix">
				...
				<li class="fl">
					<a href="<%=basePath%>information.jsp">信息交流</a>
				</li>
			</ul>
		</div>
