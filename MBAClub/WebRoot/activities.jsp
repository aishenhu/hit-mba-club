...
<%
	...
	pageBean.setPageAction("activities.jsp");
	pageBean.setTotalRecords(newsDao.getNewsCountByCategoryID(1L));

	List<News> newsList = newsDao.getNewsByCategoryID(1L, (pageNo - 1)
			* PAGE_SIZE, PAGE_SIZE);
	List<News> recentNewsList = newsDao.getNewsByCategoryID(1L, 0, 10);
%>
	...
	<body>
		...
		<div class="page-nav wrapper">
			<ul class="clearfix">
				...
				<li class="fl">
					<a href="<%=basePath%>activities.jsp">活动发布</a>
				</li>
			</ul>
		</div>
